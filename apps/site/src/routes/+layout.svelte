...
<LayoutRegions>
  <div class="min-h-screen bg-background dark:bg-slate-950">
      ...
      <div class="lg:hidden px-4 py-3 space-y-3">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-8">
            <a href="/">
              <Logo
                class="h-7 text-foreground -translate-y-px"
                id="mobile-logo" />
            </a>
            <div class="flex items-center gap-2">
              <span class="font-semibold">Regions</span>
              <span
                class="rounded-md bg-indigo-500/10 px-2 py-0.5 text-xs font-semibold text-indigo-700 dark:text-indigo-400 border border-indigo-500/20"
                >Beta</span>
            </div>
          </div>
        ...
        <div class="flex items-center justify-between">
          <nav class="flex items-center gap-4 text-sm font-medium">
            ...
            <a
              ...
              class="transition-colors hover:text-foreground/80 text-muted-foreground"
              >GitHub</a>
          </nav>
      ...
      <div class="hidden lg:block">
        <div class="w-full px-4 lg:container lg:mx-auto">
          <div class="h-14 flex items-center gap-6">
            ...
            <a href="/" class="w-64 shrink-0 flex items-center">
            ...
            <div class="flex-1 flex items-center justify-between">
              ...
              <div class="flex items-center gap-2 px-4">
                ...
                <span
                  ...
                  >Beta</span>
                <nav
                  class="flex items-center space-x-1 text-sm font-medium pl-8">
                  <a
                    href="/docs"
                    class="px-3 py-2 transition-colors hover:text-foreground/80 border-b-3 {page.url.pathname.startsWith(
                      '/docs'
                    )
                  ...
                  <a
                    href="https://github.com/sveltopia/regions"
                    class="px-3 py-2 transition-colors hover:text-foreground/80 border-b-3 border-transparent"
                    >GitHub</a>
                </nav>
              </div>
    ...
    <footer class="border-t py-6 md:py-0">
      <div
        class="w-full px-4 flex flex-col items-center justify-between gap-4 md:container md:mx-auto md:h-24 md:flex-row">
        <p class="text-sm text-muted-foreground">
          Built by <a
            href="https://sveltopia.dev"
            class="font-medium underline underline-offset-4">Sveltopia</a
