...
<div class="not-prose mb-8 rounded-lg border bg-indigo-500/5 p-6">
  ...
  <p class="mt-4 text-sm text-muted-foreground">
    ...
    <strong>Zod</strong> validator, then define your fields (galleryTitle, imageCount).
  </p>
</div>
...
<ul>
  ...
  <li>
    <strong>Zod validation</strong> - Runtime validation with the most popular TypeScript schema validator
    (~14kb bundle)
  </li>
  <li>
