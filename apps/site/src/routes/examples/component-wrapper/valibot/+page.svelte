...
<div class="not-prose mb-8 rounded-lg border bg-indigo-500/5 p-6">
  ...
  <p class="text-sm text-muted-foreground mt-4">
    ...
    and <strong>Valibot</strong> validator, then define your fields (catalogName, itemCount).
  </p>
</div>
...
<ul>
	...
	<li><strong>Valibot validation</strong> - Runtime validation with the smallest validator library (~1kb bundle)</li>
	<li><strong>Wrapper component pattern</strong> - Create a component that calls useLayoutRegions() to set region data</li>
